...
<!-- font-size 를 조절하면 원하는 크기로 글자를 조절할 수 있습니다.-->
  ...
  <div key="6">
    <a href = "https://oreuda.kr/">
      <img
        src=https://oreuda.kr/api/v1/plant/card?nickname=Yoonjyjy
        alt="oreuda"
      />
    </a>
  </div>
  ...
  <div key="1">
    <img src=http://mazassumnida.wtf/api/v2/generate_badge?boj=diniless width="280" height="140" alt="baekjoon" />
    <img src=http://mazandi.herokuapp.com/api?handle=diniless&theme=warm width="285" height="140" alt="solved" />
  </div>
  ...
  <div key="5">
    ...
    <div className=Preview_contactBadgeDiv__3demU>
      <a href=mailto:diniless@naver.com target="_blank">
            <img
...
<!--
**Yoonjyjy/Yoonjyjy** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
